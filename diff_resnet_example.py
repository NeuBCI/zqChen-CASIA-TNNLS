...
tf.app.flags.DEFINE_string(
    'rootdir', './savefile/cifar10/res32_prune0.3',
    'set root directory to save file')

tf.app.flags.DEFINE_boolean('loadprune', True, 'if load pruned parameters')

tf.app.flags.DEFINE_boolean('restore', True, 'set whether restore from file')
...
class Cifar_ResNet:
    ...
    def prune5percent(self):
        ...
        logger.info('step: %d, destroy 5 percent: %f' %
                    (self.gs, test_acc))
